	...
	<table class="mdjm-event-overview">
		<tr>
            ...
            <th class="mdjm-event-heading right-align"><?php esc_html_e( 'ID:', 'mobile-dj-manager' ); ?> {contract_id}<br />
				...
				<span class="mdjm-edit"><?php printf( __( '<a href="%1$s">Manage %2$s</a>', 'mobile-dj-manager' ), '{event_url}', mdjm_get_label_singular() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
            </th>
		</tr>
		<tr>
