...
<div id="mdjm-contract-wrapper">
	...
	<div id="mdjm-contract-header">
        ...
        <?php else : ?>
            <p class="notready"><?php printf( __( 'You cannot yet sign your contract as you have not indicated that you would like to proceed with your event. Please return to the <a href="%s">event details</a> screen to confirm that you wish to proceed.', 'mobile-dj-manager' ),
				mdjm_get_event_uri( $mdjm_event->ID ) ); ?></p>
    ...
    <div id="mdjm-contract-footer">
        ...
        <?php $disabled = ''; ?>
        <?php if( $mdjm_event->post_status != 'mdjm-contract' ) $disabled = ' disabled="disabled"'; ?>
        ...
        <div id="mdjm-contract-signature-form">
            <form name="mdjm-signature-form" id="mdjm-signature-form" method="post" action="<?php echo mdjm_get_current_page_url(); ?>">
                ...
                <div class="row mdjm-contract-signatary-name">
                ...
                <div class="row mdjm-contract-signatary-terms">
                ...
                <div class="row mdjm-contract-sign">
                    <p><input type="submit" name="mdjm_sign_contract" id="mdjm_sign_contract" value="<?php _e( 'Sign Contract', 'mobile-dj-manager' ); ?>"<?php echo $disabled; ?> /></p>
                </div>
            </form>
