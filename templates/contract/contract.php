...
<div id="mdjm-contract-wrapper">
	...
	<div id="mdjm-contract-header">
        ...
        <?php else : ?>
            <p class="mdjm-contract-notready"><?php printf( __( 'You cannot yet sign your contract as you have not indicated that you would like to proceed with your event. Please return to the <a href="%s">event details</a> screen to confirm that you wish to proceed.', 'mobile-dj-manager' ),
