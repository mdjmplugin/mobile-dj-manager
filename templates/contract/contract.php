        ...
        <div id="mdjm-contract-signature-form">
            <form name="mdjm-signature-form" id="mdjm-signature-form" method="post" action="<?php echo mdjm_get_current_page_url(); ?>">
                ...
                <div class="row mdjm-contract-signatory-name">
                    <div class="col first-name">
                        <p><label for="mdjm_first_name"><?php esc_html_e( 'First Name:', 'mobile-dj-manager' ); ?></label><br />
                            <input type="text" name="mdjm_first_name" id="mdjm_first_name" data-placeholder="<?php esc_attr_e( 'First Name', 'mobile-dj-manager' ); ?>" size="20"<?php echo $disabled; ?> /></p>
                    </div>

                    <div class="last last-name">
                        <p><label for="mdjm_last_name"><?php esc_html_e( 'Last Name:', 'mobile-dj-manager' ); ?></label><br />
                            <input type="text" name="mdjm_last_name" id="mdjm_last_name" data-placeholder="<?php esc_attr_e( 'Last Name', 'mobile-dj-manager' ); ?>" size="20"<?php echo $disabled; ?> /></p>
                    </div>
                </div>

                <div class="row mdjm-contract-signatory-terms">
                    <p><input type="checkbox" name="mdjm_accept_terms" id="mdjm_accept_terms" value="accept"<?php echo $disabled; ?> /> <label for="mdjm_accept_terms"><?php esc_html_e( 'I hereby confirm that I have read and accept the contract and its terms', 'mobile-dj-manager' ); ?></label></p>
                </div>

                <div class="row mdjm-contract-signatory-client">
                    <p><input type="checkbox" name="mdjm_confirm_client" id="mdjm_confirm_client" value="yes"<?php echo $disabled; ?> /> <label for="mdjm_confirm_client"><?php esc_html_e( 'I hereby confirm that the person named within the above contract is me and that all associated details are correct', 'mobile-dj-manager' ); ?></label></p>
                </div>
                ...
                <div class="row mdjm-contract-sign">
                    <p><input type="submit" name="mdjm_submit_sign_contract" id="mdjm_submit_sign_contract" value="<?php esc_attr_e( 'Sign Contract', 'mobile-dj-manager' ); ?>"<?php echo $disabled; ?> /></p>
                </div>
            </form>
