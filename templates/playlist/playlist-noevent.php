 ...
 */
$notice = sprintf(
	__( "We haven't been able to locate your %s. Please return to our <a href='%s'>%s</a> page to see a list of your %s.", 'mobile-dj-manager' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
