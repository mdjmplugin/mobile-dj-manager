 ...
 */
			...
			public function client_zone_enqueue()	{
				...
				wp_register_style( 'mobile-dj-manager', WPMDJM_PLUGIN_URL . '/client-zone/includes/css/mdjm-styles.css', '', MDJM_VERSION_NUM );
				...
				wp_register_script( 'mdjm-validation', WPMDJM_PLUGIN_URL . '/client-zone/includes/js/mdjm-validation.js', array( 'jquery-validation-plugin' ), MDJM_VERSION_NUM );
