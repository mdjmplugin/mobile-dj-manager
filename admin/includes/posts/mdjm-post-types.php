			...
			if( !get_taxonomy( 'event-types' ) )	{
				register_taxonomy(
					...
					array(
						...
						'capabilities'	  => array(
							'manage_terms'	=> 'edit_private_mdjm_events',
							'edit_terms'	  => 'edit_private_mdjm_events',
							'delete_terms'	=> 'edit_private_mdjm_events',
							'assign_terms'	=> 'read_mdjm_event'
						),
			...
			if( !get_taxonomy( 'transaction-types' ) )	{
				register_taxonomy(
					...
					array(
						...
						'capabilities'	  => array(
							'manage_terms'	=> 'edit_private_mdjm_txns',
							'edit_terms'	  => 'edit_private_mdjm_txns',
							'delete_terms'	=> 'edit_private_mdjm_txns',
							'assign_terms'	=> 'read_mdjm_txn'
						),
						'update_count_callback'      => '_update_generic_term_count') );
			}
			...
			if( !get_taxonomy( 'venue-details' ) )	{
				register_taxonomy(
					...
					array(
						...
						'query_var'         => true,
						'capabilities'	  => array(
							'manage_terms'	=> 'edit_mdjm_venues',
							'edit_terms'	  => 'edit_published_mdjm_venues',
							'delete_terms'	=> 'delete_mdjm_venues',
							'assign_terms'	=> 'read_mdjm_venue'
						),
