...
class MDJM_Stats {
	 ...
	 * @access public
	 * @since 1.4
	 * @var str $end_date end date of event
	 */
	public $end_date;
	 ...
	 * @access public
	 * @since 1.4
	 * @var str $event_date event date optional
	 */
	public $event_date;
	 ...
	 *
	 * This calls the convert_date() mdjmber function to ensure the dates are formatted correctly
	 *
	 * @access public
	 * @since 1.4
	 * @return void
	 * @param str $_start_date start date.
	 * @param str $_end_date end date.
	 * @param str $_event_date event date.
	 */
	 ...
	 * @param int $date convert Dates.
	 * @param int $end_date end event date.
	 */
	 ...
	 * @since 1.4
	 * @return str
	 * @param str $where modifies where flag.
	 */
		...
		if ( $txns ) {
			...
			foreach ( $txns as $txn ) {
				...
				if ( 'any' === $args['post_status'] ) {
					...
					if ( 'mdjm-income' === $txn->post_status ) {
	 ...
	 *
	 * @since 1.4
	 * @param str|bool $month The starting date for which we'd like to retrieve our earnings. If false, we'll use the default start date of `this_month`.
	 * @param str|bool $year The end date for which we'd like to retrieve our earnings. If false, we'll use the default end date of `this_year`.
	 */
