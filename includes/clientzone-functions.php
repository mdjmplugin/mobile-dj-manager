...
function mdjm_show_footer_in_client_zone() {
	...
	if ( mdjm_get_option( 'show_credits', false ) ) {
		...
		printf( __( 'Powered by <a href="%1$s" target="_blank">MDJM Event Management</a>, version %2$s', 'mobile-dj-manager' ), 'https://mdjm.co.uk', MDJM_VERSION_NUM ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
