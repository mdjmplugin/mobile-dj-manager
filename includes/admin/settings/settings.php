	...
	$all_settings = array( 
					...
					/* -- Email Settings -- */
							...
							'enquiry' => array(
									...
									'desc' => sprintf( __( 'This is the default template used when sending quotes via %semail%s to clients', 'mobile-dj-manager' ),
										'<code>', '</code>' ),
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[enquiry]',
														'sort_order' => 'ASC',
							...
							'online_enquiry' => array(
									...
									'desc' => sprintf( __( 'This is the default template used for clients viewing quotes %sonline%s via the %s application', 'mobile-dj-manager' ), 
										'<code>', '</code>', MDJM_APP ),
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[online_enquiry]',
														'sort_order' => 'ASC',
														'list_type' => 'email_template',
							...
							'unavailable' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[unavailable_email_template]',
														'sort_order' => 'ASC',
														'list_type' => 'email_template'
														),
									'section' => 'enquiry_templates',
							...
							'enquiry_from' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[enquiry_email_from]',
														'sort_order' => 'ASC',
														'list_type' => 'defined',
							...
							'contract' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[email_contract]',
														'sort_order' => 'ASC',
														'list_type' => 'email_template'
														),
									'section' => 'contract_templates',
							...
							'contract_from' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[contract_from]',
														'sort_order' => 'ASC',
														'list_type' => 'defined',
														'list_values' => array( 'admin' => 'Admin',
																				'dj'    => 'Event DJ', ),
							...
							'booking_conf_client' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[email_client_confirm]',
														'sort_order' => 'ASC',
														'list_type' => 'email_template'
														),
									'section' => 'confirmation_templates',
							...
							'booking_conf_from' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[confirm_email_from]',
														'sort_order' => 'ASC',
														'list_type' => 'defined',
														'list_values' => array( 'admin' => 'Admin',
																				'dj'    => 'Event DJ', ),
							...
							'email_dj_confirm' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[email_dj_confirm]',
														'sort_order' => 'ASC',
														'list_type' => 'email_template'
														),
									'section' => 'confirmation_templates',
							...
							'payment_cfm_template' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[payment_cfm_template]',
														'sort_order' => 'ASC',
														'list_type' => 'email_template'
														),
							...
							'manual_payment_cfm_template' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_templates_settings' . '[manual_payment_cfm_template]',
														'sort_order' => 'ASC',
														'list_type' => 'email_template',
					...
					/* -- Pages -- */
							...
							'quotes_page' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_plugin_pages' . '[quotes_page]',
					...
					/* -- Custom Text -- */
						...
						'profile_intro' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_frontend_text' . '[profile_intro]',
														'mce_settings' => array(
																			'textarea_rows' => 6,
																			'media_buttons' => false,
																			'textarea_name' => 'mdjm_frontend_text' . '[profile_intro]',
																			'teeny'         => false,
																			),
														),
						...
						'profile_pass_intro' => array(
									...
									'desc' => 'Introductory text displayed on client profile page',
									'custom_args' => array (
														'name' =>  'mdjm_frontend_text' . '[profile_pass_intro]',
														'mce_settings' => array(
																			'textarea_rows' => 6,
																			'media_buttons' => false,
																			'textarea_name' => 'mdjm_frontend_text' . '[profile_pass_intro]',
																			'teeny'         => false,
																			),
														),
									'section' => 'clientzone_text_profile',
					...
					/* -- Availability Settings -- */
							'availability_status' => array(
								...
								'key' => 'mdjm_availability_settings',
								'type' => 'multiple_select',
							...
							'availability_check_pass_page' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_availability_settings' . '[availability_check_pass_page]',
														'sort_order' => 'ASC',
							...
							'availability_check_pass_text' => array(
									...
									'custom_args' => array (
														...
														'mce_settings' => array(
																			'textarea_rows' => 6,
																			'media_buttons' => false,
																			'textarea_name' => 'mdjm_availability_settings' . '[availability_check_pass_text]',
																			'teeny'         => false,
																			),
														),
									'section' => 'clientzone_availability',
							...
							'availability_check_fail_page' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_availability_settings' . '[availability_check_fail_page]',
														'sort_order' => 'ASC',
							...
							'availability_check_fail_text' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_availability_settings' . '[availability_check_fail_text]',
														'sort_order' => 'ASC',
														...
														'mce_settings' => array(
																			'textarea_rows' => 6,
																			'media_buttons' => false,
																			'textarea_name' => 'mdjm_availability_settings' . '[availability_check_fail_text]',
																			'teeny'         => false,
																			),
														),
									'section' => 'clientzone_availability',
					...
					/* -- Payment Settings -- */
							'payment_gateway' => array(
									...
									'desc' => '',
									'custom_args' => array (
														'name' =>  'mdjm_payment_settings' . '[payment_gateway]',
														'sort_order' => '',
														'list_type' => 'defined',
														'list_values' => array( 
							...
							'currency_format' => array(
									...
									'desc' => '',
									'custom_args' => array (
														'name' =>  'mdjm_payment_settings' . '[currency_format]',
														'sort_order' => '',
														'list_type' => 'defined',
							...
							'decimal' => array(
									...
									'desc' => '',
									'custom_args' => array (
														'name' =>  'mdjm_payment_settings' . '[decimal]',
														'sort_order' => '',
														'list_type' => 'defined',
							...
							'thousands_seperator' => array(
									...
									'desc' => '',
									'custom_args' => array (
														'name' =>  'mdjm_payment_settings' . '[thousands_seperator]',
														'sort_order' => '',
														'list_type' => 'defined',
														'list_values' => array( '.' 		=> '. (' . __( 'dot' ) . ')',
																				',' 		=> ', (' . __( 'comma' ) . ')',)
							...
							'form_layout' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_payment_settings' . '[form_layout]',
														'sort_order' => '',
														'list_type' => 'defined',
							...
							'tax_type' => array(
									...
									'custom_args' => array (
														'name' =>  'mdjm_payment_settings' . '[tax_type]',
														'sort_order' => '',
														'list_type' => 'defined',
