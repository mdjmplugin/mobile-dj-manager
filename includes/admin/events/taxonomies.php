...
function mdjm_add_enquiry_source_fields( $tag ) {
	?>
    <div class="form-field term-group">
        <label for="enquiry_source_default"><?php esc_html_e( 'Set as Default Enquiry Source?', 'mobile-dj-manager' ); ?></label>
...
function mdjm_add_playlist_category_fields( $tag ) {
	...
	?>
    <div class="form-field term-group">
        <label for="playlist_default_cat"><?php esc_html_e( 'Set as default Category?', 'mobile-dj-manager' ); ?></label>
