...
class MDJM_Batch_Export_Clients extends MDJM_Batch_Export {
	...
	public function set_properties( $request ) {
		...
		$this->event    = isset( $request['event'] ) ? absint( $request['event']             )  : null;
		$this->price_id = ! empty( $request['mdjm_price_option'] ) && 0 !== $request['mdjm_price_option'] ? absint( $request['mdjm_price_option'] )   : null;
	} // set_properties
