...
function mdjm_communication_details_metabox( $post ) {
    ...
    <p>
    <?php
    printf( __( '<strong>Date Sent</strong>: %s', 'mobile-dj-manager' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    ...
    <p>
    <?php
    printf( __( '<strong>From</strong>: <a href="%1$s">%2$s</a>', 'mobile-dj-manager' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    ...
    <p>
    <?php
    printf( __( '<strong>Recipient</strong>: <a href="%1$s">%2$s</a>', 'mobile-dj-manager' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    esc_url( admin_url( "/user-edit.php?user_id={$recipient->ID}" ) ), esc_html( $recipient->display_name ) );
	?>
        </p>
