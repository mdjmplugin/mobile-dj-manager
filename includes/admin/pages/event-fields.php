...
if ( ! class_exists( 'MDJM_Event_Fields' ) ) :
	class MDJM_Event_Fields {
		...
		public static function add_new_custom_field_table( $field_types ) {
			...
			<?php
			submit_button(
				( empty( $editing ) ? esc_html__( 'Add Field', 'mobile-dj-manager' ) : esc_html__( 'Save Changes', 'mobile-dj-manager' ) ),
				'primary',
				'submit_custom_field',
				false
			);
