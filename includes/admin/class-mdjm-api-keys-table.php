...
class MDJM_API_Keys_Table extends WP_List_Table {
	 ...
	 * @since   1.4
	 *
	 * @param   arr $item           Contains all the data of the keys. str $column_name    The name of the column.
	 *
	 ...
	 * @since   1.4
	 *
	 * @param   arr $item $which Contains all the data of the keys.
	 */
	...
	public function extra_tablenav( $which = '' ) {
		...
		<form id="api-key-generate-form" method="post" action="<?php echo esc_url( admin_url( 'edit.php?post_type=mdjm-event&page=mdjm-tools&tab=api_keys' ) ); ?>">
			...
			<?php
			echo MDJM()->html->users_dropdown( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				array(
					'name'             => 'user_id',
					'chosen'           => true,
	...
	public function get_paged() {
		return isset( $_GET['paged'] ) ? absint( $_GET['paged'] ) : 1; // phpcs:ignore WordPress.Security.NonceVerification
	} // get_paged
