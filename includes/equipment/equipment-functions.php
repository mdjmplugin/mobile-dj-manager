...
function mdjm_get_package_data( $package ) {
	...
	if ( in_array( 'all', $events ) ) {
		$event_types = sprintf( esc_html__( 'All %s Types', 'mobile-dj-manager' ), esc_html( mdjm_get_label_singular() ) );
	} else {
