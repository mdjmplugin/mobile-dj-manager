	...
	if ( mdjm_employee_can( 'manage_mdjm' ) ) {
		...
		<div class="mdjm_stat_grid">
			...
			<table>
				...
				<tbody>
					<tr>
						<?php /* translators: % Enquiry or Enquiries */ ?>
			...
			<p>
				<?php
				printf(
					/* translators: %1 HTML ling $2 Create Event $s Plural handler */
				...
				<?php
				printf(
					/* translators: %1 HTML ling $2 Manage Event $s Plural handler */
			...
			<?php if ( ! empty( $sources ) ) : ?>
				...
				<?php foreach ( $sources as $count => $source ) : ?>
					<p>
						<?php /* translators: %1 Enquiry Source %2 Amount */ ?>
 ...
 *
 * @since   1.4
 * @param str $items Number of Event Items.
 */
