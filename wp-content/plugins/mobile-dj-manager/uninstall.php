...
require_once 'mobile-dj-manager.php';
...
if ( mdjm_get_option( 'remove_on_uninstall' ) ) {
	...
	foreach ( $mdjm_pages as $mdjm_page ) {
		...
		$rm_page = mdjm_get_option( $mdjm_page, false );
	...
	foreach ( $custom_tables as $custom_table ) {
		$mdjm_table_name = $wpdb->prefix . $custom_table;
		$wpdb->query( "DROP TABLE IF EXISTS $mdjm_table_name" );
		delete_option( $mdjm_table_name . '_db_version' );
	}
	...
	$all_caps = array(
		...
		'mdjm_package_edit',
		'publish_mdjm_packages',
		'edit_mdjm_packages',
		'edit_others_mdjm_packages',
		'delete_mdjm_packages',
		'delete_others_mdjm_packages',
		'read_private_mdjm_packages',

		// Comm posts.
		'mdjm_comms_send',
		'edit_mdjm_comms',
		'edit_others_mdjm_comms',
		'publish_mdjm_comms',
		'read_private_mdjm_comms',
		'edit_published_mdjm_comms',
		'delete_mdjm_comms',
		'delete_others_mdjm_comms',
		'delete_private_mdjm_comms',
		'delete_published_mdjm_comms',
		'edit_private_mdjm_comms',
		...
		'mdjm_quote_view',
		'edit_mdjm_quotes',
		'edit_others_mdjm_quotes',
		'publish_mdjm_quotes',
		'read_private_mdjm_quotes',
		'edit_published_mdjm_quotes',
		'edit_private_mdjm_quotes',
		'delete_mdjm_quotes',
		'delete_others_mdjm_quotes',
		'delete_private_mdjm_quotes',
		'delete_published_mdjm_quotes',
		...
		'mdjm_template_edit',
		'edit_mdjm_templates',
		'edit_others_mdjm_templates',
		'publish_mdjm_templates',
		'read_private_mdjm_templates',
		'edit_published_mdjm_templates',
		'edit_private_mdjm_templates',
		'delete_mdjm_templates',
		'delete_others_mdjm_templates',
		'delete_private_mdjm_templates',
		'delete_published_mdjm_templates',

		// Transaction posts.
		'mdjm_txn_edit',
		'edit_mdjm_txns',
		'edit_others_mdjm_txns',
		'publish_mdjm_txns',
		'read_private_mdjm_txns',
		'edit_published_mdjm_txns',
		'edit_private_mdjm_txns',
		'delete_mdjm_txns',
		'delete_others_mdjm_txns',
		'delete_private_mdjm_txns',
		...
		'mdjm_venue_edit',
		'edit_mdjm_venues',
		'edit_others_mdjm_venues',
		'publish_mdjm_venues',
		'read_private_mdjm_venues',
		'edit_published_mdjm_venues',
		'edit_private_mdjm_venues',
		'delete_mdjm_venues',
		'delete_others_mdjm_venues',
		'delete_private_mdjm_venues',
